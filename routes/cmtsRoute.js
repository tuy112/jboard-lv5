...
const cmtsController = require("../controller/cardCmtController");
const cmtsController = new cmtsController();

router.post("/:postId", authMiddleware, cmtsController.postCmt);
// router.get("/:cmtId", cardCmtsController.getCmt);
router.put("/:cmtId", authMiddleware, cmtsController.updateCmt);
router.delete("/:cmtId", cmtsController.deleteCmt);
